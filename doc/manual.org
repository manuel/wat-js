...
/Wat/ is an advanced systems scripting language.  It provides a
nuanced set of features, such as delimited continuations, resumable
exceptions, dynamic binding, first-class environments, fexprs, macros,
generic functions, protocols, and first-class types.
