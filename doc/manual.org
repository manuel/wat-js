...
** =handle <handlers> . <body> → result= [operative] /NIY/
...
** =catch <handlers> . <body> → result= [operative] /NIY/
...
** =invoke-restart <restart> → result= [operative] /NIY/

** =compute-restarts <exception> → list= [operative] /NIY/
