var wat = (function() {
	...
	bind(e, new Sym("label"), jswrap(function(type) { return new Str(label(type)); }));
	bind(e, new Sym("set-label!"), jswrap(function(type, name) { set_label(type, name.jsstr); return name; }));
	bind(e, new Sym("debug-info"), jswrap(dbg));
